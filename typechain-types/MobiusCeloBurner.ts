...
export interface MobiusCeloBurnerInterface extends utils.Interface {
  contractName: "MobiusCeloBurner";
  functions: {
...
export interface MobiusCeloBurner extends BaseContract {
  contractName: "MobiusCeloBurner";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MobiusCeloBurnerInterface;
