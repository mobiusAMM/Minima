...
export interface MoolaWrapperInterface extends utils.Interface {
  contractName: "MoolaWrapper";
  functions: {
...
export interface MoolaWrapper extends BaseContract {
  contractName: "MoolaWrapper";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MoolaWrapperInterface;
